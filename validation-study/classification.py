#
'''
classification.py: This program classifies energy consumption data into activity states.
	It performs the two steps of classification as discussed in the paper.
